...
;function $b(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;m=k=0}
...
;function ac(a,b,c){var d=[],e=[];if(1==("array"==ua(c)?2:1))return e=[b,a],F(d,function(g){e.push(g)}),bc(e.join(" "));
...
a=bc(e.join(" "));a=[c,a];0==l.length||a.push(l.join(""));return a.join("_")}
function bc(a){var b=$b();b.update(a);return b.V().toLowerCase()}
;function cc(a){var b=Zb(String(y.location.href)),c;(c=y.__SAPISID||y.__APISID||y.__OVERRIDE_SID)?c=!0:(c=new Ib(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?y.__SAPISID:y.__APISID,c||(c=new Ib(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(y.location.href);return d&&c&&b?[b,ac(Zb(d),c,a||null)].join(" "):null}return null}
;/*
...
;function jc(){this.g=this.f=null}
var lc=new fc(function(){return new kc},function(a){a.reset()});
jc.prototype.add=function(a,b){var c=lc.get();c.set(a,b);this.g?this.g.next=c:this.f=c;this.g=c};
jc.prototype.remove=function(){var a=null;this.f&&(a=this.f,this.f=this.f.next,this.f||(this.g=null),a.next=null);return a};
function kc(){this.next=this.scope=this.f=null}
kc.prototype.set=function(a,b){this.f=a;this.scope=b;this.next=null};
kc.prototype.reset=function(){this.next=this.scope=this.f=null};function mc(a){nc||oc();pc||(nc(),pc=!0);qc.add(a,void 0)}
var nc;function oc(){if(y.Promise&&y.Promise.resolve){var a=y.Promise.resolve(void 0);nc=function(){a.then(rc)}}else nc=function(){var b=rc;
!wa(y.setImmediate)||y.Window&&y.Window.prototype&&!H("Edge")&&y.Window.prototype.setImmediate==y.setImmediate?(hc||(hc=ic()),hc(b)):y.setImmediate(b)}}
var pc=!1,qc=new jc;function rc(){for(var a;a=qc.remove();){try{a.f.call(a.scope)}catch(c){gc(c)}var b=lc;b.i(a);100>b.g&&(b.g++,a.next=b.f,b.f=a)}pc=!1}
;function sc(){this.g=-1}
;function tc(){this.g=64;this.f=[];this.m=[];this.u=[];this.i=[];this.i[0]=128;for(var a=1;a<this.g;++a)this.i[a]=0;this.l=this.h=0;this.reset()}
E(tc,sc);tc.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.l=this.h=0};
function uc(a,b,c){c||(c=0);var d=a.u;if("string"===typeof b)for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.f[0];c=a.f[1];var l=a.f[2],g=a.f[3],h=a.f[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=g^c&(l^g);var k=1518500249}else f=c^l^g,k=1859775393;else 60>e?(f=c&l|g&(c|l),k=2400959708):
...
tc.prototype.update=function(a,b){if(null!=a){void 0===b&&(b=a.length);for(var c=b-this.g,d=0,e=this.m,f=this.h;d<b;){if(0==f)for(;d<=c;)uc(this,a,d),d+=this.g;if("string"===typeof a)for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.g){uc(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.g){uc(this,e);f=0;break}}this.h=f;this.l+=b}};
tc.prototype.digest=function(){var a=[],b=8*this.l;56>this.h?this.update(this.i,56-this.h):this.update(this.i,this.g-(this.h-56));for(var c=this.g-1;56<=c;c--)this.m[c]=b&255,b/=256;uc(this,this.m);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.f[c]>>d&255,++b;return a};function vc(){this.h=this.h;this.i=this.i}
vc.prototype.h=!1;vc.prototype.dispose=function(){this.h||(this.h=!0,this.G())};
vc.prototype.G=function(){if(this.i)for(;this.i.length;)this.i.shift()()};var wc="StopIteration"in y?y.StopIteration:{message:"StopIteration",stack:""};function L(){}
...
return e};var Ec=y.JSON.stringify;function M(a){vc.call(this);this.u=1;this.l=[];this.m=0;this.f=[];this.g={};this.A=!!a}
E(M,vc);r=M.prototype;r.subscribe=function(a,b,c){var d=this.g[a];d||(d=this.g[a]=[]);var e=this.u;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.u=e+3;d.push(e);return e};
...
function Hc(a,b,c){mc(function(){a.apply(b,c)})}
...
function ve(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||O("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ra||O("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().qa:b=cc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=O("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=O("DELEGATED_SESSION_ID")));return d}
function we(a){a=Object.assign({},a);delete a.Authorization;var b=cc();if(b){var c=new tc;c.update(O("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;void 0===c&&(c=0);if(!Fb){Fb={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var l=d.concat(e[f].split(""));Eb[f]=l;for(var g=0;g<l.length;g++){var h=l[g];void 0===Fb[h]&&(Fb[h]=g)}}}c=Eb[c];d=[];for(e=0;e<b.length;e+=3){var k=b[e],m=(f=e+1<b.length)?b[e+1]:
