...
;function Nc(a,b,c){var d=[],e=[];if(1==(Aa(c)?2:1))return e=[b,a],F(d,function(g){e.push(g)}),Oc(e.join(" "));
...
function Rc(a){-1==a.f&&(a.f=Ra(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
...
function gg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.pb||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().ob:b=Pc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
n.loadNewVideoConfig=function(a){if(!this.g){this.T&&(T(this.T),this.T=0);a instanceof Hh||(a=new Hh(a));this.ca=a;this.f=a.clone();Qh(this);this.W||(this.W=Sh(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Ic(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Ic(Number(a)||a);Rh(this);this.w&&Th(this)}};
...
"requestIds",Y.GetMusicSearchSuggestions_rid="requestIds",Y.REQUEST_ID="requestIds",Y),Ei="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Fi={},Gi=(Fi.ccs="CANARY_STATE_",Fi.mver="MEASUREMENT_VERSION_",Fi.pis="PLAYER_INITIALIZED_STATE_",
...
;function Ti(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);id(this,Ka(jd,this.f))}
...
n.dispose=function(){bj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function fj(a,b,c){M.call(this);this.f=a;this.i=c;this.j=W(window,"message",A(this.l,this));this.h=new Ui(this,a,b);id(this,Ka(jd,this.h))}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Sg.dispose();a=0;for(var b=Mg.length;a<b;a++){var c=Mg[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):T(c)}}Mg.length=0;Kg("//static.doubleclick.net/instream/ad_status.js");Ng=!1;P("DCLKSTAT",0);kd(Aj,zj);if(a=yj)a.removeEventListener("onScreenChanged",Dj),a.removeEventListener("onLogClientVeCreated",Cj),a.removeEventListener("onLogServerVeCreated",Ej),a.removeEventListener("onLogVeClicked",Fj),a.removeEventListener("onLogVesShown",
Gj),a.destroy();Bj={}});
